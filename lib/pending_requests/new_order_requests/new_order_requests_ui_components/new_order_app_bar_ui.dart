...
class NewOrderAppBarUi extends StatelessWidget implements PreferredSizeWidget {
  final int count;

  const NewOrderAppBarUi({super.key, required this.count});
